...
$bvmain = new Pressable();

register_uninstall_hook(__FILE__, array('Pressable', 'uninstall'));
...
if (is_admin()) {
	...
	##ACTIVATEWARNING##
	add_action('admin_enqueue_scripts', array($bvadmin, 'pblsecAdminMenu'));
}
