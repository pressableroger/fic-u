...
class PBLAdmin {
	...
	public function pblsecAdminMenu($hook) {
		if ($hook === 'toplevel_page_pressable') {
			wp_register_style('bvpbl_normalize', plugins_url('assets/css/normalize.css',__FILE__ ));
			wp_register_style('bvpbl_skeleton', plugins_url('assets/css/skeleton.css',__FILE__ ));
			wp_register_style('bvpbl_form-styles', plugins_url('assets/css/form-styles.css',__FILE__ ));
			wp_enqueue_style('bvpbl_normalize');
			wp_enqueue_style('bvpbl_skeleton');
